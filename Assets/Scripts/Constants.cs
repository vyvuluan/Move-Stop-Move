public static class Constants
{
    ...
    public const string IsWinAnim = "IsWin";
    public const string FailAnim = "fail";
    public const string IsUtilAnim = "IsUtil";
